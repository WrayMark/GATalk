...
- PyQt-Fluent-Widgets：公开仓库说明免费版本使用 GPLv3，商业用途提供单独
  商业许可；0.10.0 不引入、不复制其代码或资源。
...
0.10.0 的 GATalk 主题和设置完全使用现有 PySide6 / Qt API 独立实现。
Microsoft WinUI Gallery、Windows 设计文档、Qt 样式表文档和公开 Qt 主题
仓库只用于界面原则调研，未复制其代码、图标或资源；本版本未新增依赖。
